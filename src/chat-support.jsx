...
const mockGenerateResponse = async (input) => {
  ...
  const responses = {
    ...
    schedule:
      "Tech Fest 2025 runs from June 15-17. We have keynotes, workshops, and networking events each day. Check out the timeline section for details!",
    speakers:
      "We have amazing speakers including Dr. Eliza Chen, Marcus Johnson, Sophia Rodriguez, and Dr. James Park. They'll be discussing AI, quantum computing, robotics, and VR/AR.",
    location: "Tech Fest 2025 will be held at the Innovation Center, 123 Tech Boulevard, Silicon Valley, CA.",
    tickets:
      "Early bird tickets are available now! Regular admission is $299, VIP passes are $499, and student tickets are $99.",
    default:
